...
class Wrap:
    ...
    def __init__(
        ...
        jdata = jdata_deepmd_input_v1_ni256["apumd"] if loc_version == 1 else jdata_deepmd_input_v0["apumd"]
...
def wrap(
    *,
    apumd_config: Optional[str] = "apumd/config.npy",
    apumd_weight: Optional[str] = "apumd/weight.npy",
    apumd_map: Optional[str] = "apumd/map.npy",
    apumd_model: Optional[str] = "apumd/model.pb",
    **kwargs,
) -> None:
