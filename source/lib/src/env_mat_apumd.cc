...
/*
//==================================================
  env_mat_a_apumd_quantize_cpu
//==================================================
*/

template <typename FPTYPE>
void deepmd::env_mat_a_apumd_quantize_cpu(std::vector<FPTYPE>& descrpt_a,
  ...
  for (int sec_iter = 0; sec_iter < int(sec_a.size()) - 1; ++sec_iter) {
    for (int nei_iter = sec_a[sec_iter]; nei_iter < sec_a[sec_iter + 1];
      ...
      FPTYPE nr2;
      dotmul_flt_apumd(nr2, rij, rij, 3);
...
template void deepmd::env_mat_a_apumd_quantize_cpu<double>(
...
template void deepmd::env_mat_a_apumd_quantize_cpu<float>(
