...
/*
//==================================================
  prod_env_mat_a_apumd_quantize_cpu
//==================================================
*/

template <typename FPTYPE>
void deepmd::prod_env_mat_a_apumd_quantize_cpu(FPTYPE* em,
                                               FPTYPE* em_deriv,
                                               FPTYPE* rij,
                                               int* nlist,
                                               const FPTYPE* coord,
...
#pragma omp parallel for
  for (int ii = 0; ii < nloc; ++ii) {
    ...
    env_mat_a_apumd_quantize_cpu(d_em_a, d_em_a_deriv, d_rij_a, d_coord3,
...
template void deepmd::prod_env_mat_a_apumd_quantize_cpu<double>(
    double* em,
    double* em_deriv,
    double* rij,
    int* nlist,
...
template void deepmd::prod_env_mat_a_apumd_quantize_cpu<float>(
    float* em,
    float* em_deriv,
    float* rij,
    int* nlist,
