...
class MatmulFltApumdOp : public OpKernel {
 public:
  /// Constructor.
  explicit MatmulFltApumdOp(OpKernelConstruction* context) : OpKernel(context) {
...
#define REGISTER_CPU(T)                                                 \
  REGISTER_KERNEL_BUILDER(                                              \
      Name("MatmulFltApumd").Device(DEVICE_CPU).TypeConstraint<T>("T"), \
      MatmulFltApumdOp<CPUDevice, T>);
REGISTER_CPU(float);
REGISTER_CPU(double);
